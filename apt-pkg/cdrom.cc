...
{
   int Res = 0;
   if (Path.find("stable/") != string::npos or
	   Path.find("tmax-stable/") != string::npos)
      Res += 29;
   if (Path.find("/binary-") != string::npos)
      Res += 20;
   if (Path.find("testing/") != string::npos or
	   Path.find("tmax-testing/") != string::npos)
      Res += 28;
   if (Path.find("unstable/") != string::npos or
	   Path.find("tmax-unstable/") != string::npos)
      Res += 27;
   ...
   if (Path.find("/source/") != string::npos)
      Res += 10;
   if (Path.find("/debian/") != string::npos or
	   Path.find("/tmax/") != string::npos)
      Res -= 10;
